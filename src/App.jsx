...
import TeacherAddComponentPage from "./pages/TeacherAddComponentPage";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/teacherYears/:yearId/teacherCourses/:courseId/groups/teacherCreateCards/teacherAddComponent" element={<TeacherAddComponentPage />} />
